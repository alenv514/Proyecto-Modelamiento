<?php
session_start();
// ...validación de usuario vendedor si lo deseas...
?>
<!DOCTYPE html>
<html>
<head>
    <title>ShopMate - Vendedor</title>
    ...
    <div class="main-content">
        <aside class="sidebar">
            <ul>
                ...
                <li><span>&#128722;</span> Gestionar Productos</li>
                <li><span>&#128179;</span> Revisar Pedidos</li>
                <li><span>&#128202;</span> Revisar Estadisticas</li>
                <li><span>&#128176;</span> Revisar Ventas</li>
                <li><span>&#9881;</span> Productos Reportados</li>
                <li><span>&#9881;</span> Gestionar Intereses</li>
            </ul>
        </aside>
        <section class="panel">
